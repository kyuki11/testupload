                    ...
                    <div class="row-fluid">
                        ...
                        <div class="widget-box">
                                        <div class="widget-header header-color-blue">
                                               ...
                                               <?php
                                                                echo '<a href="'.base_url().'index.php/guru/tambah_absen" class="btn btn-primary float-right"<i class ="icon-edit"></i> Tambah Data</a>';
                                                                ?>
                                                        ...
                                                        <tr>
                                                            <td class=""><table width="100%" border="1" style="border-collapse:collapse" cellspacing="2" cellpadding="2" class="table table-striped table-bordered table-hover">
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td><?php echo $d ['tk']; ?></td>
                                                                <td><?php
                                                                echo '<a href="'.base_url().'index.php/guru/edit_absen/'.$d['nis'].' "class="badge badge-primary">Edit</a>
                                                                
                                                                <a href="'.base_url().'index.php/guru/hapus_absen/'.$d['nis'].'"
