        ...
        ?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="widget-box">
                                        ...
                                        <?php
                                                                echo '<a href="'.base_url().'index.php/admin/tambah_pengajar" class="btn btn-primary float-right"<i class ="icon-edit"></i> Tambah Data</a>';
                                                                ?>
                                            <h5 class="bigger lighter">
                                                <i class="icon-table"></i>Data Master Pengajar</h5>
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th width="1129" align="left">
                                                                <i class="icon-user"></i>
                                                                <span class="label label-large label-pink arrowed-right">DATA PENGAJAR</span><span class="label label-warning arrowed arrowed-right"> <?php $query = $this->db->query("select * from pengajar");
                                                                echo $query->num_rows();
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="15%"><b>Kode Mata Pelajaran</b></td>
                                                                <td width="25%"><b>Nama Mata Pelajaran</b></td>
                                                            ...
                                                            <?php
                                                            foreach ($pengajar->result_array() as $d)
                                                            {
                                                            ?>
                                                            <tr>
                                                                <td><?php echo $d ['id']; ?></td>
                                                                ...
                                                                <td><?php
                                                                echo '<a href="'.base_url().'index.php/admin/edit_pengajar/'.$d['id'].' "class="badge badge-primary">Edit</a>
                                                                
                                                                <a href="'.base_url().'index.php/admin/hapus_pengajar/'.$d['id'].'"
