                      ...
                      <div class="widget-main no-padding">
                        ...
                        ?>
                                                ...
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><b><?php echo $m ['nama_lengkap']; ?></td></b>
                                                </tr>
                                                <tr>
                                                  <td align="right">Username</td>
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="username" type="text" id="username" size="50" value="<?php echo $m['username']; ?>">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td width="4%" align="center">:</td>
                                                  <td width="75%"><label>
                                                    <input name="password" type="text" id="password" size="50" value="<?php echo $m['password']; ?>">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  <td align="right">Status</td>
                                                  <td align="center">:</td>
                                                  <td><b><?php echo $m ['stts']; ?></td></b>
                                                </tr>
                                                
                                                <tr>
                                                  <td>&nbsp;</td>
                                                  <td>&nbsp;</td>
                                                  <td><button class="btn btn-small btn-primary"><i class="icon-download-alt"></i> Simpan Data</button> <a href="<?php echo base_url();?>index.php/admin/user" class="btn btn-danger btn-small"> <i class="icon-external-link"></i>Kembali</a>
