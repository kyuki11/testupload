          ...
          <div class="widget-box">
            <div class="widget-header header-color-blue">
              <h5 class="bigger lighter">
                <i class="icon-table"></i>Form Tambah Pengajar
              </h5>
            </div>
                  ...
                  <table width="100%" border="1" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                      ...
                      <td><label for="mapel"></label>
                        <label>
                          <input id="mapel" name="mapel" type="text" placeholder="" class="form-control input-md" required="">
                        </label>
                      </td>
        ...
        <script>
          $(document).ready(function() {
            ...
            //yang dilakukan ketika isi input kd_mapel2 berubah
