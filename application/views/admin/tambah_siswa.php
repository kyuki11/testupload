                        ...
                        <div class="widget-box">
                                        <div class="widget-header header-color-blue">
                                            <h5 class="bigger lighter">
                                                <i class="icon-table"></i>Form Tambah Siswa</h5>
                                        </div>
                                              ...
                                              <table width="100%" border="1" cellspacing="2" cellpadding="2">
                                                <tr>
                                                  ...
                                                  <td width="71%"><label ></label>
                                                    <label for="id"></label>
                                                    <input name="id" type="text" id="id" size="50" value="A<?= mt_rand(1, 9999999999) ?>" readonly></td>
                                                </tr>
                                                <tr>
                                                  <td align="right">NIS</td>
                                                  <td align="center">:</td>
                                                  <td><label for="nis"></label>
                                                  <input name="nis" type="text" id="nis" size="50"></td>
                                                </tr>
                                                <tr>
